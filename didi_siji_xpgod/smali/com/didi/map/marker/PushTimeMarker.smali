.class public Lcom/didi/map/marker/PushTimeMarker;
.super Lcom/didi/map/marker/BaseMarker;
.source "PushTimeMarker.java"


# instance fields
.field private mAdapter:Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;
...
.method public hideMarker()V
    ...
    .prologue
    .line 64
    new-instance v0, Lcom/didi/map/marker/PushTimeMarker$1;

    invoke-direct {v0, p0}, Lcom/didi/map/marker/PushTimeMarker$1;-><init>(Lcom/didi/map/marker/PushTimeMarker;)V
...
.method public onMapClick(Lcom/tencent/tencentmap/mapsdk/maps/model/LatLng;)V
    ...
    .prologue
    .line 85
    invoke-virtual {p0}, Lcom/didi/map/marker/PushTimeMarker;->isRemove()Z
    ...
    .line 86
    invoke-virtual {p0}, Lcom/didi/map/marker/PushTimeMarker;->showInfoWindow()V
...
.method public onMarkerClick(Lcom/tencent/tencentmap/mapsdk/maps/model/Marker;)Z
    ...
    iget-object v1, p0, Lcom/didi/map/marker/PushTimeMarker;->mAdapter:Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;
...
.method public setMarker(DDI)V
    ...
    .prologue
    .line 97
    iget-object v1, p0, Lcom/didi/map/marker/PushTimeMarker;->marker:Lcom/tencent/tencentmap/mapsdk/maps/model/Marker;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/didi/map/marker/PushTimeMarker;->show(Lcom/tencent/tencentmap/mapsdk/maps/model/MarkerOptions;I)V
...
.method protected showInfoWindow()V
    ...
    .prologue
    .line 23
    iget-object v0, p0, Lcom/didi/map/marker/PushTimeMarker;->mAdapter:Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;

    if-nez v0, :cond_0

    .line 24
    new-instance v0, Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;

    invoke-direct {v0}, Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;-><init>()V

    iput-object v0, p0, Lcom/didi/map/marker/PushTimeMarker;->mAdapter:Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;
...
.method public updateCarContent(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/didi/map/marker/PushTimeMarker;->updateCarContent(Ljava/lang/String;Z)V
...
.method public updateCarContent(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;->updateCarTime(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;->setDefaultBackground()V
    ...
    invoke-virtual {v0}, Lcom/didi/map/marker/adapter/PushDriveTimeMarkerAdapter;->setProgressBackground()V
...
.method public updatePushCarTime(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/didi/map/marker/PushTimeMarker;->updateCarContent(Ljava/lang/String;)V
