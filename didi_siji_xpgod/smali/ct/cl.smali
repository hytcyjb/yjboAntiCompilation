...
.method public static a(Lct/be;)Landroid/telephony/CellLocation;
    .locals 6
    .parameter
    ...
    :try_start_2
    invoke-static {v4}, Lct/cl;->b(Landroid/telephony/CellLocation;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {v4}, Lct/cl;->a(Landroid/telephony/CellLocation;)I
    ...
    :cond_0
    iget-object v0, p0, Lct/be;->a:Landroid/content/Context;

    invoke-static {v0}, Lct/cl;->a(Landroid/content/Context;)Z
    ...
    :cond_1
    sput-boolean v2, Lct/cl;->a:Z

    .line 83
    :cond_2
    sget-boolean v0, Lct/cl;->a:Z
...
.method public static a(Lct/ca;)Z
    .locals 5
    .parameter

    .prologue
    .line 199
    invoke-static {p0}, Lct/b$a;->a(Ljava/lang/Object;)Z
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lct/cl;->a(IIIII)Z
...
.method public static b(Lct/be;)Ljava/util/List;
    .locals 3
    .parameter
