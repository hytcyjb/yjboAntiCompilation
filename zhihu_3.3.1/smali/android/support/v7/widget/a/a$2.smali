...
.method public a(Z)V
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/a/a;->a(Landroid/support/v7/widget/a/a;Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
...
.method public a(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v2}, Landroid/support/v7/widget/a/a;->d(Landroid/support/v7/widget/a/a;)Landroid/support/v4/view/e;

    move-result-object v2

    invoke-virtual {v2, p2}, Landroid/support/v4/view/e;->a(Landroid/view/MotionEvent;)Z

    .line 310
    invoke-static {p2}, Landroid/support/v4/view/u;->a(Landroid/view/MotionEvent;)I
    ...
    invoke-static {p2, v1}, Landroid/support/v4/view/u;->b(Landroid/view/MotionEvent;I)I
    ...
    iget-object v2, v2, Landroid/support/v7/widget/a/a;->b:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    iget-object v4, v2, Landroid/support/v7/widget/a/a$c;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    invoke-static {v3, v4, v0}, Landroid/support/v7/widget/a/a;->a(Landroid/support/v7/widget/a/a;Landroid/support/v7/widget/RecyclerView$ViewHolder;Z)I
    ...
    iget-object v5, v2, Landroid/support/v7/widget/a/a$c;->h:Landroid/support/v7/widget/RecyclerView$ViewHolder;

    invoke-virtual {v3, v4, v5}, Landroid/support/v7/widget/a/a$a;->c(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-static {v3, v4, v2}, Landroid/support/v7/widget/a/a;->a(Landroid/support/v7/widget/a/a;Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-static {v2, v3, v1}, Landroid/support/v7/widget/a/a;->a(Landroid/support/v7/widget/a/a;Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-static {p2, v3}, Landroid/support/v4/view/u;->a(Landroid/view/MotionEvent;I)I
...
.method public b(Landroid/support/v7/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    invoke-static {v1}, Landroid/support/v7/widget/a/a;->d(Landroid/support/v7/widget/a/a;)Landroid/support/v4/view/e;

    move-result-object v1

    invoke-virtual {v1, p2}, Landroid/support/v4/view/e;->a(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {p2, v2}, Landroid/support/v4/view/u;->a(Landroid/view/MotionEvent;I)I
    ...
    iget-object v3, v3, Landroid/support/v7/widget/a/a;->b:Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {v1, v2, v0}, Landroid/support/v7/widget/a/a;->a(Landroid/support/v7/widget/a/a;Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    ...
    invoke-static {v0, v3}, Landroid/support/v7/widget/a/a;->a(Landroid/support/v7/widget/a/a;Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 394
    :pswitch_4
    invoke-static {p2}, Landroid/support/v4/view/u;->b(Landroid/view/MotionEvent;)I
