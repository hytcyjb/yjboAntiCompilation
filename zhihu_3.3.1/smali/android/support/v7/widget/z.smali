...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->b:Landroid/view/animation/LinearInterpolator;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/z;->c:Landroid/view/animation/DecelerateInterpolator;

    .line 88
    iput v1, p0, Landroid/support/v7/widget/z;->e:I

    iput v1, p0, Landroid/support/v7/widget/z;->f:I
    ...
    iput v0, p0, Landroid/support/v7/widget/z;->a:F
...
.method public a(Landroid/view/View;I)I
    ...
    .prologue
    .line 300
    invoke-virtual {p0}, Landroid/support/v7/widget/z;->e()Landroid/support/v7/widget/RecyclerView$h;
    ...
    invoke-virtual {v4}, Landroid/support/v7/widget/RecyclerView$h;->D()I
    ...
    .line 310
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/z;->a(IIIII)I
...
.method protected a(IILandroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .prologue
    .line 121
    invoke-virtual {p0}, Landroid/support/v7/widget/z;->j()I
    ...
    invoke-direct {p0, v0, p1}, Landroid/support/v7/widget/z;->a(II)I
    ...
    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/z;->a(II)I
    ...
    .line 135
    invoke-virtual {p0, p4}, Landroid/support/v7/widget/z;->a(Landroid/support/v7/widget/RecyclerView$q$a;)V
...
.method protected a(Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .line 227
    invoke-virtual {p0}, Landroid/support/v7/widget/z;->i()I

    move-result v0

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/z;->a(I)Landroid/graphics/PointF;
    ...
    .line 237
    :cond_1
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/z;->a(Landroid/graphics/PointF;)V

    .line 238
    iput-object v0, p0, Landroid/support/v7/widget/z;->d:Landroid/graphics/PointF;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/z;->c(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/z;->b:Landroid/view/animation/LinearInterpolator;
...
.method protected a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/RecyclerView$q$a;)V
    ...
    .prologue
    .line 107
    invoke-virtual {p0}, Landroid/support/v7/widget/z;->c()I

    move-result v0

    invoke-virtual {p0, p1, v0}, Landroid/support/v7/widget/z;->b(Landroid/view/View;I)I

    move-result v0

    .line 108
    invoke-virtual {p0}, Landroid/support/v7/widget/z;->d()I

    move-result v1

    invoke-virtual {p0, p1, v1}, Landroid/support/v7/widget/z;->a(Landroid/view/View;I)I
    ...
    .line 110
    invoke-virtual {p0, v2}, Landroid/support/v7/widget/z;->b(I)I
    ...
    iget-object v3, p0, Landroid/support/v7/widget/z;->c:Landroid/view/animation/DecelerateInterpolator;
...
.method protected b(I)I
    ...
    .prologue
    .line 174
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/z;->c(I)I
...
.method protected c()I
    ...
    .line 201
    iget-object v0, p0, Landroid/support/v7/widget/z;->d:Landroid/graphics/PointF;
...
.method protected c(I)I
    ...
    iget v1, p0, Landroid/support/v7/widget/z;->a:F
