...
# instance fields
.field final a:Landroid/support/v7/widget/h;
...
.method constructor <init>(Landroid/widget/ProgressBar;Landroid/support/v7/widget/h;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/v7/widget/j;->c:Landroid/widget/ProgressBar;

    .line 49
    iput-object p2, p0, Landroid/support/v7/widget/j;->a:Landroid/support/v7/widget/h;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 74
    instance-of v0, p1, Landroid/support/v4/b/a/i;
    ...
    invoke-interface {v0}, Landroid/support/v4/b/a/i;->a()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/b/a/i;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 101
    iget-object v1, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/Bitmap;

    if-nez v1, :cond_7

    .line 102
    iput-object v0, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/Bitmap;
...
.method a()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 146
    iget-object v0, p0, Landroid/support/v7/widget/j;->d:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/j;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/j;->b:[I

    invoke-static {v0, p1, v1, p2, v3}, Landroid/support/v7/widget/ap;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ap;

    move-result-object v0

    .line 56
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ap;->b(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 58
    iget-object v2, p0, Landroid/support/v7/widget/j;->c:Landroid/widget/ProgressBar;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ap;->b(I)Landroid/graphics/drawable/Drawable;
