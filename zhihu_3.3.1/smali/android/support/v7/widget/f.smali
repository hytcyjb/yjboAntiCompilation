...
.method constructor <init>(Landroid/view/View;Landroid/support/v7/widget/h;)V
    ...
    .line 42
    iput-object p2, p0, Landroid/support/v7/widget/f;->b:Landroid/support/v7/widget/h;
...
.method private c(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 145
    iget-object v0, p0, Landroid/support/v7/widget/f;->e:Landroid/support/v7/widget/an;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->e:Landroid/support/v7/widget/an;
    ...
    invoke-static {v1}, Landroid/support/v4/view/ah;->C(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Landroid/support/v4/view/ah;->D(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 158
    iput-boolean v2, v0, Landroid/support/v7/widget/an;->c:Z

    .line 159
    iput-object v1, v0, Landroid/support/v7/widget/an;->b:Landroid/graphics/PorterDuff$Mode;

    .line 162
    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/an;->d:Z

    if-nez v1, :cond_3

    iget-boolean v1, v0, Landroid/support/v7/widget/an;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/an;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 94
    iget-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/an;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/an;

    iget-object v0, v0, Landroid/support/v7/widget/an;->a:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/an;

    .line 87
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/an;

    iput-object p1, v0, Landroid/support/v7/widget/an;->a:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/an;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/an;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/an;->c:Z
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/an;->b:Landroid/graphics/PorterDuff$Mode;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 128
    iget-object v0, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/an;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/an;
...
.method c()V
    ...
    .line 114
    iget-object v1, p0, Landroid/support/v7/widget/f;->d:Landroid/support/v7/widget/an;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/an;[I)V
    ...
    .line 117
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/f;->c:Landroid/support/v7/widget/an;
    ...
    .line 121
    invoke-direct {p0, v0}, Landroid/support/v7/widget/f;->c(Landroid/graphics/drawable/Drawable;)V
