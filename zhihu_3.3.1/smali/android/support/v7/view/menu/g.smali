...
.method public a()V
    ...
    .prologue
    .line 137
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/e;
...
.method public a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/app/e$a;-><init>(Landroid/content/Context;)V

    .line 57
    new-instance v2, Landroid/support/v7/view/menu/e;

    invoke-virtual {v1}, Landroid/support/v7/app/e$a;->a()Landroid/content/Context;

    move-result-object v3

    sget v4, Landroid/support/v7/a/a$h;->abc_list_menu_item_layout:I
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/app/e$a;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/e$a;
    ...
    .line 68
    invoke-virtual {v1, v2}, Landroid/support/v7/app/e$a;->a(Landroid/view/View;)Landroid/support/v7/app/e$a;

    .line 75
    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/app/e$a;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/app/e$a;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/e;

    .line 79
    iget-object v0, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/e;

    invoke-virtual {v0, p0}, Landroid/support/v7/app/e;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/app/e$a;->a(Ljava/lang/CharSequence;)Landroid/support/v7/app/e$a;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/e;->d()Landroid/widget/ListAdapter;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    .line 95
    iget-object v1, p0, Landroid/support/v7/view/menu/g;->c:Landroid/support/v7/app/e;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/view/menu/f;->b(Z)V
